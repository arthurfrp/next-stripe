...
const Product = props => {
  ...
  useEffect(() => {
    ...
    setAdding(false);
    toast.success(`${qty} ${props.name} adicionado${qty > 1 ? 's' : ''}`, {
      id: toastId.current,
    });
    setQty(1);
  }, [cartCount]);
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-12">
          ...
          <div className="flex-1 max-w-md border border-opacity-50 rounded-md shadow-lg p-6">
            ...
            <p>
              ...
              <span className="font-semibold">Em campo</span>
            </p>
            ...
            <div className="mt-4 border-t pt-4">
              {/* Quantity */}
              <p className="text-gray-500">Qunatidade:</p>
