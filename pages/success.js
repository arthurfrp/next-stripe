    ...
    <div className="container xl:max-w-screen-xl mx-auto py-12 px-6 text-center">
      {error ? (
        <div className="p-2 rounded-md bg-rose-100 text-rose-500 max-w-md mx-auto">
          <p className="text-lg">Desculpe, Alguma coisa aconteeu errado!</p>
        </div>
      ) : !data ? (
        ...
        <div className="py-4 px-8 rounded-md bg-gray-100 max-w-lg mx-auto">
          <h2 className="text-4xl font-semibold flex flex-col items-center space-x-1">
            ...
            <span>Obrigado pelo pedido!</span>
          </h2>
          <p className="text-lg mt-3">Confira o recibo em sua caixa de entrada.</p>
        </div>
      )}
    </div>
  );
